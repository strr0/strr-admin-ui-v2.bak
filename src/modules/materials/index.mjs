import { defineComponent as L, useSlots as $e, computed as d, openBlock as g, createElementBlock as $, normalizeClass as f, normalizeStyle as xe, createElementVNode as y, Fragment as O, withDirectives as B, unref as u, renderSlot as m, vShow as z, createCommentVNode as N, createStaticVNode as we, createVNode as Me, withModifiers as Be, createBlock as te, resolveDynamicComponent as ze, mergeProps as je, withCtx as Z } from "vue";
...
function Ve(t) {
  const {
    ...
    footerHeight: h
  } = t, c = a - 3, C = a - 5, I = e === "vertical" || o ? a - 1 : a - 4, V = o ? a - 2 : 0, M = a - 5;
  return Ie({
    headerHeight: s,
    headerZIndex: c,
    tabHeight: r,
...
const p = {
  ...
  setup(t, { emit: e }) {
    const o = t, a = $e(), s = d(() => Ve(o)), r = d(() => !!a.header && o.headerVisible), l = d(() => !!a.tab && o.tabVisible), i = d(() => !o.isMobile && !!a.sider && o.siderVisible), h = d(() => o.isMobile && !!a.sider && o.siderVisible), c = d(() => !!a.footer && o.footerVisible), C = d(() => o.scrollMode === "wrapper"), I = d(() => o.scrollMode === "content"), V = d(() => o.mode === "vertical"), M = d(() => o.mode === "horizontal"), j = d(() => o.fixedTop || M.value && C.value), T = d(() => !o.fullContent && i.value ? o.siderCollapse ? p["left-gap_collapsed"] : p["left-gap"] : ""), K = d(() => V.value ? T.value : ""), Q = d(() => {
    ...
    return (n, ee) => (g(), $("div", {
      ...
      y("div", {
        ...
        r.value ? (g(), $(O, { key: 0 }, [
          ...
          B(y("div", {
            class: f([u(p)["layout-header-placement"], "soybeanjs-hg8qlw"])
          }, null, 2), [
        ...
        l.value ? (g(), $(O, { key: 1 }, [
          ...
          B(y("div", {
            class: f([u(p)["layout-tab-placement"], "soybeanjs-hg8qlw"])
          }, null, 2), [
            [z, !n.fullContent && j.value]
          ])
        ], 64)) : N("", !0),
        i.value ? B((g(), $("aside", {
          ...
          class: f([
            ...
            n.siderClass,
            _e.value,
            n.siderCollapse ? u(p)["layout-sider_collapsed"] : u(p)["layout-sider"]
          ])
        }, [
          m(n.$slots, "sider")
        ], 2)), [
        ...
        h.value ? (g(), $(O, { key: 3 }, [
          y("aside", {
            class: f([
              ...
              n.siderCollapse ? "overflow-hidden" : u(p)["layout-sider"]
            ])
          }, [
            m(n.$slots, "sider")
          ], 2),
          B(y("div", {
            class: f(["soybeanjs-4ibers", u(p)["layout-mobile-sider-mask"]]),
            onClick: Ce
          }, null, 2), [
            [z, !n.siderCollapse]
          ])
        ...
        c.value ? (g(), $(O, { key: 4 }, [
          ...
          B(y("div", {
            class: f([u(p)["layout-footer-placement"], "soybeanjs-hg8qlw"])
          }, null, 2), [
...
var qe = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }, w = function(t) {
  ...
  return { h: 60 * (i < 0 ? i + 6 : i), s: r ? l / r * 100 : 0, v: r / 255 * 100, a: s };
}, pe = function(t) {
  var e = t.h, o = t.s, a = t.v, s = t.a;
  e = e / 360 * 6, o /= 100, a /= 100;
  var r = Math.floor(e), l = a * (1 - o), i = a * (1 - (e - r) * o), h = a * (1 - (1 - e + r) * o), c = r % 6;
  return { r: 255 * [a, i, l, l, h, a][c], g: 255 * [h, a, a, i, l, l][c], b: 255 * [l, l, h, a, a, i][c], a: s };
}, ae = function(t) {
  return { h: he(t.h), s: _(t.s, 0, 100), l: _(t.l, 0, 100), a: _(t.a) };
}, se = function(t) {
  return { h: b(t.h), s: b(t.s), l: b(t.l), a: b(t.a, 3) };
}, re = function(t) {
  return pe((o = (e = t).s, { h: e.h, s: (o *= ((a = e.l) < 50 ? a : 100 - a) / 100) > 0 ? 2 * o / (a + o) * 100 : 0, v: a + o, a: e.a }));
  var e, o, a;
}, q = function(t) {
  return { h: (e = fe(t)).h, s: (s = (200 - (o = e.s)) * (a = e.v) / 100) > 0 && s < 200 ? o * a / 100 / (s <= 100 ? s : 200 - s) * 100 : 0, l: s / 2, a: e.a };
  var e, o, a, s;
}, Te = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Oe = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Re = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Ee = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, G = { string: [[function(t) {
  var e = Se.exec(t);
  return e ? (t = e[1]).length <= 4 ? { r: parseInt(t[0] + t[0], 16), g: parseInt(t[1] + t[1], 16), b: parseInt(t[2] + t[2], 16), a: t.length === 4 ? b(parseInt(t[3] + t[3], 16) / 255, 2) : 1 } : t.length === 6 || t.length === 8 ? { r: parseInt(t.substr(0, 2), 16), g: parseInt(t.substr(2, 2), 16), b: parseInt(t.substr(4, 2), 16), a: t.length === 8 ? b(parseInt(t.substr(6, 2), 16) / 255, 2) : 1 } : null : null;
}, "hex"], [function(t) {
  var e = Re.exec(t) || Ee.exec(t);
  return e ? e[2] !== e[4] || e[4] !== e[6] ? null : oe({ r: Number(e[1]) / (e[2] ? 100 / 255 : 1), g: Number(e[3]) / (e[4] ? 100 / 255 : 1), b: Number(e[5]) / (e[6] ? 100 / 255 : 1), a: e[7] === void 0 ? 1 : Number(e[7]) / (e[8] ? 100 : 1) }) : null;
}, "rgb"], [function(t) {
  var e = Te.exec(t) || Oe.exec(t);
  if (!e)
    return null;
  var o, a, s = ae({ h: (o = e[1], a = e[2], a === void 0 && (a = "deg"), Number(o) * (qe[a] || 1)), s: Number(e[3]), l: Number(e[4]), a: e[5] === void 0 ? 1 : Number(e[5]) / (e[6] ? 100 : 1) });
  return re(s);
}, "hsl"]], object: [[function(t) {
  var e = t.r, o = t.g, a = t.b, s = t.a, r = s === void 0 ? 1 : s;
  return w(e) && w(o) && w(a) ? oe({ r: Number(e), g: Number(o), b: Number(a), a: Number(r) }) : null;
}, "rgb"], [function(t) {
  var e = t.h, o = t.s, a = t.l, s = t.a, r = s === void 0 ? 1 : s;
  if (!w(e) || !w(o) || !w(a))
    return null;
  var l = ae({ h: Number(e), s: Number(o), l: Number(a), a: Number(r) });
  return re(l);
}, "hsl"], [function(t) {
  ...
  if (!w(e) || !w(o) || !w(a))
    return null;
  var l = function(i) {
    return { h: he(i.h), s: _(i.s, 0, 100), v: _(i.v, 0, 100), a: _(i.a) };
  ...
  return typeof t == "string" ? ne(t.trim(), G.string) : typeof t == "object" && t !== null ? ne(t, G.object) : [null, void 0];
}, A = function(t, e) {
  var o = q(t);
  ...
  return t.prototype.isValid = function() {
    ...
    return e = fe(this.rgba), { h: b(e.h), s: b(e.s), v: b(e.v), a: b(e.a, 3) };
    var e;
    ...
    return typeof e == "number" ? v({ r: (o = this.rgba).r, g: o.g, b: o.b, a: e }) : b(this.rgba.a, 3);
    var o;
  }, t.prototype.hue = function(e) {
    var o = q(this.rgba);
    return typeof e == "number" ? v({ h: e, s: o.s, l: o.l, a: o.a }) : b(o.h);
  ...
  var e, o, a = { x: 0.9555766 * (e = t).x + -0.0230393 * e.y + 0.0631636 * e.z, y: -0.0282895 * e.x + 1.0099416 * e.y + 0.0210077 * e.z, z: 0.0122982 * e.x + -0.020483 * e.y + 1.3299098 * e.z };
  return o = { r: D(0.032404542 * a.x - 0.015371385 * a.y - 4985314e-9 * a.z), g: D(-969266e-8 * a.x + 0.018760108 * a.y + 41556e-8 * a.z), b: D(556434e-9 * a.x - 2040259e-9 * a.y + 0.010572252 * a.z), a: t.a }, { r: x(o.r, 0, 255), g: x(o.g, 0, 255), b: x(o.b, 0, 255), a: x(o.a) };
}, We = function(t) {
  var e = F(t.r), o = F(t.g), a = F(t.b);
  return function(s) {
    return { x: x(s.x, 0, X), y: x(s.y, 0, Y), z: x(s.z, 0, J), a: x(s.a) };
  }(function(s) {
    return { x: 1.0478112 * s.x + 0.0228866 * s.y + -0.050127 * s.z, y: 0.0295424 * s.x + 0.9904844 * s.y + -0.0170491 * s.z, z: -92345e-7 * s.x + 0.0150436 * s.y + 0.7521316 * s.z, a: s.a };
  }({ x: 100 * (0.4124564 * e + 0.3575761 * o + 0.1804375 * a), y: 100 * (0.2126729 * e + 0.7151522 * o + 0.072175 * a), z: 100 * (0.0193339 * e + 0.119192 * o + 0.9503041 * a), a: t.a }));
}, S = 216 / 24389, H = 24389 / 27, ue = function(t) {
  var e = We(t), o = e.x / X, a = e.y / Y, s = e.z / J;
  return o = o > S ? Math.cbrt(o) : (H * o + 16) / 116, { l: 116 * (a = a > S ? Math.cbrt(a) : (H * a + 16) / 116) - 16, a: 500 * (o - a), b: 200 * (a - (s = s > S ? Math.cbrt(s) : (H * s + 16) / 116)), alpha: e.a };
}, Fe = function(t, e, o) {
  var a, s = ue(t), r = ue(e);
  return function(l) {
    var i = (l.l + 16) / 116, h = l.a / 500 + i, c = i - l.b / 200;
    return Ae({ x: (Math.pow(h, 3) > S ? Math.pow(h, 3) : (116 * h - 16) / H) * X, y: (l.l > 8 ? Math.pow((l.l + 16) / 116, 3) : l.l / H) * Y, z: (Math.pow(c, 3) > S ? Math.pow(c, 3) : (116 * c - 16) / H) * J, a: l.alpha });
  }({ l: x((a = { l: s.l * (1 - o) + r.l * o, a: s.a * (1 - o) + r.a * o, b: s.b * (1 - o) + r.b * o, alpha: s.alpha * (1 - o) + r.alpha * o }).l, 0, 400), a: a.a, b: a.b, alpha: x(a.alpha) });
};
function De(t) {
  function e(o, a, s) {
    s === void 0 && (s = 5);
...
const Ye = { style: { width: "100%", height: "100%" } }, Je = /* @__PURE__ */ we('<defs><symbol id="geometry-left" viewBox="0 0 214 36"><path d="M17 0h197v36H0v-2c4.5 0 9-3.5 9-8V8c0-4.5 3.5-8 8-8z"></path></symbol><symbol id="geometry-right" viewBox="0 0 214 36"><use xlink:href="#geometry-left"></use></symbol><clipPath><rect width="100%" height="100%" x="0"></rect></clipPath></defs><svg width="51%" height="100%"><use xlink:href="#geometry-left" width="214" height="36" fill="currentColor"></use></svg><g transform="scale(-1, 1)"><svg width="51%" height="100%" x="-100%" y="0"><use xlink:href="#geometry-right" width="214" height="36" fill="currentColor"></use></svg></g>', 3), Ke = [
  ...
  setup(t, { emit: e }) {
    ...
    return (i, h) => (g(), te(ze(a.value.component), je({
      class: a.value.class,
      style: s.value
    }, r.value), {
      prefix: Z(() => [
